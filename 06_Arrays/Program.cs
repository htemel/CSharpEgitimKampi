...
namespace _06_Arrays
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine(cities[5]);//5.elaman yok dizi dışına çıktı
            ...
            //numbers[3] = 24;
            //numbers[7] = 748;
            //Console.WriteLine(numbers[5]);//değer ataması yapılmadığı için sıfır olur


            //string[] cities = { "Prag", "Roma", "Atina", "Ankara", "Tunceli" };
            ...
            //char[] symbols = { 'A', 'B', 'C', '*', '/', '-' };//char tanımlanırken tek tırnak kullanılır
